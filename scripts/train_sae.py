#!/usr/bin/env python3
"""Phase-1 stub for SAE training entrypoint."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train SAE (phase-1 scaffold).")
...
def main() -> None:
    ...
    metadata_path = write_run_metadata(env, vars(args), config, stage="train_sae")

    print("[phase-1] SAE environment resolved successfully")
    ...
    print("[phase-1] SAE training loop is not implemented yet.")
