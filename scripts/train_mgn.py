#!/usr/bin/env python3
"""Phase-1 stub for MGN training entrypoint."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train MGN (phase-1 scaffold).")
    add_common_args(parser, include_resume=True)
    parser.add_argument(
        "--epochs", type=int, default=None, help="Optional epoch override."
    )
    parser.add_argument(
        "--max-steps", type=int, default=None, help="Optional step cap."
    )
